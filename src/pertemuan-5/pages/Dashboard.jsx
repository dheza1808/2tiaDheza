    ...
    return (
        <div id="dashboard-container">
            <div id="dashboard-grid" className="p-5 grid sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div id="dashboard-orders" className="flex items-center space-x-5 
                bg-white rounded-b-lg shadow-md p-4">
                    <div id="orders-icon" className="bg-hijau rounded-b-full p-4">
                ...
                <div id="dashboard-delivered" className="flex items-center space-x-5 
                bg-white rounded-b-lg shadow-md p-4">
                    <div id="delivered-icon" className="bg-hijau rounded-b-full p-4">
                ...
                <div id="dashboard-canceled" className="flex items-center space-x-5 
                bg-white rounded-b-lg shadow-md p-4">
                    <div id="canceled-icon" className="bg-hijau rounded-b-full p-4">
                ...
                <div id="dashboard-revenue" className="flex items-center space-x-5 
                bg-white rounded-b-lg shadow-md p-4">
                    <div id="revenue-icon" className="bg-hijau rounded-b-full p-4">
