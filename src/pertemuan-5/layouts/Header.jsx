...
export default function Header() {
    return (
        <div id="header-container" className="flex items-center justify-between p-4 gap-4">
            {/* Search Bar */}
            <div id="search-bar" className="relative w-full max-w-lg">
                <input
                    id="search-input" className="border border-gray-100 p-2 pr-10 bg-white w-full rounded-md outline-none"
                    type="text"
            ...
            <div id="icons-container" className="flex items-center space-x-4 flex-shrink-0">
                {/* Icons */}
